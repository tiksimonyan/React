...
export class App extends Component {
	...
	loginHandler = async () => {
		...
		try {
			...
			const response = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=${a}`, data)
	...
	reginterHandler = async () => {
		...
		try {
			...
			const response = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=${a}`, data)
			console.log(response.data)
		} catch (error) {
			console.log(error)
		}
...
//AIzaSyCLNjrO1cJU7UFcLOz1fkdxXbgUGLiuNFQ
//https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCLNjrO1cJU7UFcLOz1fkdxXbgUGLiuNFQ